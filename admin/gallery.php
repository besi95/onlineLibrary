      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
              ...
              <a style="float:right;display: inline;" href="editoLiber.php?liberId=new" class="btn btn-theme">SHTO LIBER</a>
                <a style="float:right;display: block;margin-left: 10px;background-color: #35a8e1;border: 1px solid #35a8e1 " href="shtoAutor.php" class="btn btn-theme">SHTO AUTOR</a>
            </h3>
                <hr>
              <div class="row mt">
              <?php $i=0;
              while($libri = $liber->fetch_assoc()){?>
					...
					<div class="col-md-3 desc text-center">
						<div class="project-wrapper">
                            ...
                            <a style="display: inline-block;margin-top: 10px;" class="btn btn-theme" href="<?php echo "editoLiber.php?liberId=".$libri['id']?>">Faqja Librit</a>
		                </div>
					</div><!-- col-lg-4 -->
              <?php } ?>
				</div><!-- /row -->
