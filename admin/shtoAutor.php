        ...
        <section class="wrapper">
            ...
            <div class="row mt">
                ...
                <div class="col-md-8 col-sm-6 col-xs-12 personal-info">
                    <h3>Informacioni Autorit</h3>
                    <form class="form-horizontal" role="form" method="post" action="src/shtoAutor.php">
                        <div class="form-group">
                            <label class="col-lg-3 control-label">Emri:</label>
                            <div class="col-lg-8">
                                <input class="form-control" name="emri" " type="text" required>
                            </div>
                        </div>
                        <div class="form-group">
